...
description: >
  推理重于规则的期货趋势跟踪决策辅助系统。
  FinClaw整合 + 统一数据路由 + 知识锚点 + 分级输出 + 套利分析 + Reasoner Agent 深度分析 + 持仓健康度评估 + 闭环迭代因子进化引擎，
...
> 版本号已重置为 v0.x.0（开发阶段），历史版本号见 [VERSION_MANAGEMENT.md](docs/VERSION_MANAGEMENT.md)

| 版本 | 日期 | 关键变更 |
|------|------|---------|
| v0.1.0 | 2026-06-17 | 新架构版：FinClaw整合+统一数据路由+知识锚点+分级输出+套利分析，475个测试 |
| ~~v6.1.0~~ | ~~2026-06-17~~ | 已重置为 v0.1.0 |
| ~~v6.0.0~~ | ~~2026-06-16~~ | 已合并到 v0.1.0 前序开发 |
| ~~v5.0.0~~ | ~~2026-06-16~~ | 已合并到 v0.1.0 前序开发 |
