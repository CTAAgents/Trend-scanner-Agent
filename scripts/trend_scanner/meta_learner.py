...
class BayesianScoringOptimizer:
    ...
    def optimize(self, objective_func, n_iterations: int = 50,
    ...
    def _update_best(self, result: OptimizationResult):
        ...
        if self.best_result is None:
            ...
            best_score = (self.best_result.sharpe_ratio * 0.5 + 
...
class MetaLearningEngine:
    ...
    def run_full_optimization(self, historical_data: List[Dict] = None,
        ...
        # 运行贝叶斯优化
        best_result = self.bayesian_optimizer.optimize(
