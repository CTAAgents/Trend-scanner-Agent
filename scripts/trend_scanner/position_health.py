...
class PositionHealthChecker:
    ...
    def check(self, position: Dict[str, Any], kline_days: int = 120) -> Dict[str, Any]:
        ...
        try:
            ...
            recommendation = self._generate_recommendation(
                health_score, health_grade, technical_result, capital_result
            )
            
            # 10. 识别风险因素
            risk_factors = self._identify_risk_factors(
                technical_result, capital_result, market_result
            )
    ...
    def _get_kline_data(self, symbol: str, days: int) -> Optional[pd.DataFrame]:
        """获取K线数据"""
        try:
    ...
    def _evaluate_reasoning(
        ...
        technical: Dict, capital: Dict, market: Dict
    ) -> Dict[str, Any]:
        """LLM推理评估"""
        try:
            # 构造信号数据
    ...
    def _calculate_health_score(
        self, technical: Dict, capital: Dict, market: Dict, reasoning: Dict
    ) -> float:
        """计算综合健康度评分"""
        scores = {
    ...
    def _generate_recommendation(
        self, score: float, grade: str, technical: Dict, capital: Dict
    ) -> str:
        """生成操作建议"""
    ...
    def _identify_risk_factors(
        self, technical: Dict, capital: Dict, market: Dict
    ) -> List[str]:
        """识别风险因素"""
        risk_factors = []
