...
class ReportParser:
    ...
    def parse_report(self, report_content: str, report_metadata: Dict[str, Any] = None) -> ReportAnalysis:
        ...
        # 生成因子建议
        factor_suggestions = self._generate_factor_suggestions(
            key_viewpoints, data_logic, logic_chains
        )
...
"""
    ...
    def _create_factor_suggestion_from_viewpoint(self, viewpoint: KeyViewpoint) -> Optional[FactorSuggestion]:
        """
        从观点创建因子建议
    ...
    def _create_factor_suggestion_from_logic_chain(self, logic_chain: LogicChain) -> Optional[FactorSuggestion]:
        """
        从逻辑链创建因子建议
